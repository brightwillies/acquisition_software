                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            <div class="auth-logo">
                                <a href="/hod-login" class="auth-logo-light">
                                ...
                                <a href="/hod-login" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
...
export default {
    ...
    methods: {
        ...
        adminLogin() {
            ...
            this.$axios
                .post("/api/hod/v1/auth/login", formData, {
                    headers: {
                    ...
                    (response) => {
                        if (response) {
                            ...
                            if (res.code == 200) {
                                ...
                                localStorage.setItem("acicms_platform_hod", userData.user.mask);
                                localStorage.setItem("acicms_platform_hod_firstname", userData.user.first_name);
                                localStorage.setItem("acicms_platform_hod_pass", userData.token);
                                // axios.defaults.headers.common["Authorization"] =
                                //     "Bearer " + userData.token;
                                store.commit("loginUser");
                                 this.successToastRedirect(res.message, "/hod-dashboard");
