<template>
    <div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="singleItem in tableData" :key="singleItem.id">
                                            ...
                                            <td>
                                                ...
                                                <span v-if="singleItem.hod_status === 'Approved'" class="badge badge-pill badge-soft-success font-size-12"> {{
    
                                                            singleItem.hod_status }}</span>
    
    
    
                                                <span v-if="singleItem.hod_status === 'Received'" class="badge badge-pill badge-soft-secondary font-size-12"> {{
    
                                                            singleItem.hod_status }}</span>
    
                                                <span v-if="singleItem.hod_status === 'Update'" class="badge badge-pill badge-soft-danger font-size-12">{{
                                            ...
                                            <td>
                                                ...
                                                <span v-if="singleItem.revised_status === 'Approved'" class="badge badge-pill badge-soft-success font-size-12"> {{
    
                                                            singleItem.revised_status }}</span>
    
    
    
                                                <span v-if="singleItem.revised_status === 'Received'" class="badge badge-pill badge-soft-secondary font-size-12"> {{
    
                                                            singleItem.revised_status }}</span>
    
                                                <span v-if="singleItem.revised_status === 'Update'" class="badge badge-pill badge-soft-danger font-size-12">{{
                                            ...
                                            <td>
                                                ...
                                                <!-- <div class="d-flex gap-3">
                                                        ...
                                                        <a v-if="singleItem.hod_status === 'Update'" href="javascript:void(0);"
    
                                                            @click="launchEditModal(singleItem)" class="text-success"><i
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"> <span v-show="!editmode"> Adding</span> <span v-show="editmode"> Updating</span> {{ item_name }} Information</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea readonly v-model="form.items" class="form-control" id="productdesc" rows="5" placeholder=""></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea readonly v-model="form.purpose" class="form-control" id="productdesc" rows="5" placeholder=""></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input readonly id="productname" v-model="form.place_of_use" name="productname" type="text" class="form-control">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input readonly v-model="form.receiving_company_name" id="manufacturername" name="manufacturername" type="text" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input readonly v-model="form.receiving_company_telephone" id="manufacturerbrand" name="manufacturerbrand" type="text" class="form-control">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input readonly v-model="form.receiving_company_email" id="manufacturerbrand" name="manufacturerbrand" type="text" class="form-control">
                                ...
                                <div class="mb-3" v-if="form.method_of_payment == 'Momo'">
                                    ...
                                    <input id="manufacturerbrand" v-model="form.momo_number" name="manufacturerbrand" type="text" class="form-control">
                                ...
                                <div class="mb-3" v-if="form.method_of_payment == 'Cash Cheque'">
                                    ...
                                    <input id="manufacturerbrand" v-model="form.why_cash_cheque" name="manufacturerbrand" type="text" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-for="(file, key) in files" :key="key" class="file-listing" style="margin-bottom:10px;">
        ...
        <div class="modal fade" id="recordDetailsModal" tabindex="-1" role="dialog" aria-labelledby="orderdetailsModalLabel" aria-hidden="true">
...
export default {
    ...
    data() {
        return {
            ...
            item_api: "/api/hod/v1/acquisition/other-request",
