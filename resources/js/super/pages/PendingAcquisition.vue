                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Other Acquisitions :</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3" v-if="form.method_of_payment == 'Momo'">
                                    ...
                                    <input id="manufacturerbrand" v-model="form.momo_number" name="manufacturerbrand"
                                        type="text" class="form-control">
                                </div>

                                <div class="mb-3" v-if="form.method_of_payment == 'Cash Cheque'">
                                    <label for="manufacturerbrand">Why Cash Cheque </label>
                                    <input id="manufacturerbrand" v-model="form.why_cash_cheque" name="manufacturerbrand"
                                        type="text" class="form-control">
                                </div>
...
export default {
    ...
    data() {
        return {
            ...
            item_api: "/api/admin/v1/acquisition/pending-request",
