                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <v-select id="sort_by_location" v-model="form.department_id"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label class="col-md-12 col-form-label">HOD Status</label>
                                            <div class="col-md-12">
                                                <select disabled v-model="form.hod_status" class="form-select">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="mb-3">
                                            <label for="productdesc">HOD Note </label>
                                            <textarea disabled v-model="form.hod_note" class="form-control" id="productdesc"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            <label class="col-md-12 col-form-label">Types of financial Document</label>
                                            <div class="col-md-12">
                                                <select v-model="form.type_of_financial_document" class="form-select">
                                                    <option value="Quote/Proforma">Quote/Proforma</option>
                                                    <option value="Invoice">Invoice</option>
                                                    <option value="Re-Imbursement">Re-Imbursement</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            <label class="col-md-12 col-form-label">Type of Transaction</label>
                                            <div class="col-md-12">
                                                <select v-model="form.type_of_transaction" class="form-select">
                                                    <option value="Purchase">Purchase</option>
                                                    <option value="Service/Labour Request">Service/Labour Request</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            <label class="col-md-12 col-form-label">Type of Expenditure</label>
                                            <div class="col-md-12">
                                                <select v-model="form.type_of_expediture" class="form-select">
                                                    <option value="Cheque">Operational Expenditure</option>
                                                    <option value="Transfer">Capital Expenditure</option>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <select v-model="form.revised_status" class="form-select">
                                                    <option value="Received">Received</option>
                                                    <option value="Approved">Approved</option>
                                                    <option value="Update">Update</option>
                                                </select>
...
export default {
    ...
    data() {
        return {
            ...
            item_api: "/api/admin/v1/acquisition",
    ...
    methods: {
        ...
        getRecord() {
            ...
            axios
                .get("/api/admin/v1/acquisition/" + gallery_mask)
                .then(({ data }) => {
        ...
        updateRecord() {
            ...
            formData.append("revised_status", this.form.revised_status);
            formData.append("type_of_financial_document", this.form.type_of_financial_document);
            formData.append("type_of_transaction", this.form.type_of_transaction);
            formData.append("type_of_expediture", this.form.type_of_expediture);
            this.$axios
