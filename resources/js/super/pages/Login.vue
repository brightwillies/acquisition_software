                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            <div class="auth-logo">
                                <a href="/administrator-login" class="auth-logo-light">
                                ...
                                <a href="/administrator-login" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                    ...
                    (response) => {
                        if (response) {
                            ...
                            if (res.code == 200) {
                                ...
                                localStorage.setItem("acicms_platform_admin", userData.user.mask);
                                localStorage.setItem("acicms_platform_admin_firstname", userData.user.first_name);
                                localStorage.setItem("acicms_platform_admin_pass", userData.token);
