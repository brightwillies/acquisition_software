                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        <v-select v-model="form.department_id" :options="rolesData" placeholder="Select Deparment"
                                    ...
                                    <div class="mb-3 mt-5">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <label for="">Is He/She Head of Department ?</label>
                                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            item_api: "/api/admin/v1/department-head",
            setting_api: "/api/admin/v1/department",
            item_name: "Head of Department",
