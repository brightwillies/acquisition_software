...
<html class="no-js" lang="zxx">
   ...
   <body>
      ...
      <main>
         ...
         <section class="login__area pt-90 pb-100">
            <div class="container">
                           ...
                           <div class="login__form">
                              <form>
                                 <div class="login__input-wrapper">
                                    <div class="login__input-item">
                                       <div class="login__input">
                                          <input name="email" type="email" placeholder="Enter your email" id="email" value="">
                                          <span>
                                 ...
                                 <div class="login__option mb-25 d-sm-flex justify-content-between">
                                    ...
                                    <div class="login__forgot"><a class="login__top p" href="/forgot-password">forgot password?</a></div>
                                 </div>
                                 <div class="login__btn text-center"><button type="submit" class="fill-btn clip-btn">SignIn</button></div>
                              </form>
