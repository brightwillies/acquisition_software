   ...
   <main>
      ...
      <div class="order__form-details pt-120 pb-90">
         <div class="container">
            ...
            <input type="text" name="pick_up_google_location" id="autocomplete" class="form-control" placeholder="Choose Location">
            <input type="hidden" id="pick_uplatitude" name="pick_up_latitude" class="form-control">
            <input type="hidden" name="pick_up_longitude" id="pick_up_longitude" class="form-control">
        </div>
                     </div>
                  </div>
               </div>
